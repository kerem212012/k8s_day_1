...
- [День 1: Итоги](#день-1-итоги)
- [Установка окружения](#установка-окружения)
- [Архитектура](#архитектура)
- [Ключевые команды](#ключевые-команды)
- [Запуск и эксплуатация](#запуск-и-эксплуатация)
- [Сложности и решения](#сложности-и-решения)
- [Выводы по Kubernetes](#выводы-по-kubernetes)
...
|------|-----------|--------|
| 2026-03-26 | День 1: Базовая настройка K8s | ✅ Завершено |
| 2026-03-27 | День 2: Добавить базу данных | ⏳ В плане |
| 2026-03-28 | День 3: Автомасштабирование | ⏳ В плане |

---

Этот README документирует первый день практического обучения Kubernetes! 🚀
